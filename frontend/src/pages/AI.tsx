      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-12">
        ...
        >
           ...
           <motion.div 
             ...
             className="absolute top-[15%] left-0 z-20 flex items-center gap-2 bg-dark-800/80 backdrop-blur-md border border-green-500/30 px-4 py-2 rounded-full shadow-[0_0_20px_rgba(34,197,94,0.2)]"
           >
           ...
           <motion.div 
             ...
             className="absolute top-[10%] right-0 z-20 flex items-center gap-2 bg-dark-800/80 backdrop-blur-md border border-yellow-500/30 px-4 py-2 rounded-full shadow-[0_0_20px_rgba(234,179,8,0.2)]"
           >
           ...
           <motion.div 
             ...
             className="absolute bottom-[20%] right-[-5%] z-20 flex items-center gap-2 bg-dark-800/80 backdrop-blur-md border border-red-500/30 px-4 py-2 rounded-full shadow-[0_0_20px_rgba(239,68,68,0.2)]"
           >
