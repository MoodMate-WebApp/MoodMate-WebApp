...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/'); // Optionally redirect to home or keep them on a waiting page
    } catch (error: any) {
    ...
    <div className="min-h-screen w-full bg-[#020617] text-slate-200 selection:bg-indigo-500/30 flex items-center justify-center relative overflow-x-hidden font-sans py-12">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 relative z-10 items-center">
        ...
        <div className="flex flex-col h-full">
          ...
          {/* Logo */}
          <Link to="/" className="flex items-center gap-3 mb-16 self-start group">
          ...
          <div className="mb-12">
            <h1 className="text-5xl xl:text-6xl font-bold text-white leading-[1.1] mb-8 tracking-tight">
              ...
              and <span className="text-[#818cf8]">understand</span><br/>
              <span className="text-[#818cf8]">emotions</span> better.
            </h1>
            <p className="text-slate-400 text-lg md:text-xl leading-relaxed max-w-lg font-light">
              Join MoodMate and start analyzing text, tracking moods, and improving your emotional well-being.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6 mt-auto">
             <div className="bg-[#020617]/60 backdrop-blur-xl border border-white/5 rounded-2xl p-6 shadow-xl shadow-black/40">
                <ShieldCheck className="w-8 h-8 text-[#818cf8] mb-4" />
                <h4 className="text-white font-bold text-sm mb-2">Secure</h4>
                <p className="text-[11px] text-slate-500 leading-relaxed font-medium">Your data is safe with us.</p>
             </div>
             <div className="bg-[#020617]/60 backdrop-blur-xl border border-white/5 rounded-2xl p-6 shadow-xl shadow-black/40">
                <Zap className="w-8 h-8 text-[#818cf8] mb-4" />
                <h4 className="text-white font-bold text-sm mb-2">Fast & Easy</h4>
                <p className="text-[11px] text-slate-500 leading-relaxed font-medium">Get started in just a few seconds.</p>
             </div>
             <div className="bg-[#020617]/60 backdrop-blur-xl border border-white/5 rounded-2xl p-6 shadow-xl shadow-black/40">
                <BarChart3 className="w-8 h-8 text-[#818cf8] mb-4" />
                <h4 className="text-white font-bold text-sm mb-2">Insightful</h4>
                <p className="text-[11px] text-slate-500 leading-relaxed font-medium">Understand emotions with AI power.</p>
             </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center items-center lg:items-end">
          <div className="w-full max-w-[560px] bg-[#020617]/60 backdrop-blur-3xl border border-indigo-500/20 rounded-[3rem] p-10 lg:p-14 shadow-[0_0_100px_rgba(0,0,0,0.8)] relative overflow-hidden">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <p className="text-slate-400 text-sm">Sign up to get started with MoodMate</p>
            </div>
            ...
            <form className="space-y-6 relative z-10" onSubmit={handleSignup}>
              ...
              <div className="grid grid-cols-2 gap-6">
                 <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-500 group-focus-within:text-white transition-colors" />
                      <input 
                        type="text" 
                        value={firstName}
                        onChange={(e) => setFirstName(e.target.value)}
                        className="w-full bg-[#020617] border border-white/5 rounded-2xl px-12 py-4 text-white placeholder:text-slate-700 focus:outline-none focus:border-indigo-500/30 transition-all font-light text-sm" 
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-500 group-focus-within:text-white transition-colors" />
                  <input 
                    type="email" 
                    autoComplete="email" 
                    value={email}
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-500 group-focus-within:text-white transition-colors" />
                  <input 
                ...
                <div className="flex items-center gap-2 text-[11px] text-slate-500 mt-2 ml-1">
                   <CheckCircle2 className="w-3.5 h-3.5 text-green-500" />
                   <span>At least 8 characters with uppercase, number & symbol</span>
                </div>
              </div>
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-indigo-600 to-indigo-500 text-white font-bold py-4.5 rounded-2xl transition-all shadow-lg shadow-indigo-500/20 mt-4 text-lg disabled:opacity-70 disabled:cursor-not-allowed"
              >
              ...
              <div className="grid grid-cols-2 gap-6">
                <button className="flex items-center justify-center gap-3 bg-[#020617] hover:bg-[#0f172a] border border-white/10 text-slate-300 hover:text-white font-medium py-4 rounded-2xl transition-all text-xs shadow-lg shadow-black/20">
            ...
            <div className="mt-12 text-center relative z-10">
              <p className="text-slate-500 text-sm font-medium">
                Already have an account? <Link to="/login" className="text-indigo-400 hover:text-indigo-300 font-bold transition-colors ml-1">Login</Link>
              </p>
            </div>
          </div>
        </div>
