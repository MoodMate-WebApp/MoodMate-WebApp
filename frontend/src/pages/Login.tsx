...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full selection:bg-primary-500/30 flex items-center justify-center relative overflow-hidden font-sans">
      <BackgroundMesh />
      ...
      <div className="w-full max-w-[1440px] mx-auto px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 relative z-10 items-center min-h-screen py-12">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="relative w-full max-w-[200px] sm:max-w-md aspect-square mb-12 lg:mb-20 mx-auto lg:mx-0">
             {/* Main Brain Glow */}
        ...
        <div className="flex flex-col justify-center items-center lg:items-end w-full">
          <div className="w-full max-w-[520px] bg-dark-950/40 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] p-10 lg:p-14 shadow-2xl relative overflow-hidden">
